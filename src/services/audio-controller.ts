...
import type { SubtitleEntry, TTSOptions, LanguageCode } from '../types';
...
class AudioPlaybackController {
  ...
  removeFromQueue(subtitleId: string) {
    this.audioQueue = this.audioQueue.filter(item => item.subtitle.id !== subtitleId);
  }
...
export { AudioPlaybackController, type AudioQueueItem, type AudioControllerOptions };
